class Pitch.PitchSetup.UI
    ...
    if self.admin
      pitchDetails = """
        <div class="pitch-card">
          <div class="body" onclick='window.location = "/pitch/#{pitch.pitch_id}/panels"'>
          ...
          <div class="pitch-card-footer">
            <div class="tooltip learners">#{moment.utc(pitch.demo_date).format('ll')}
                  <span class="tooltiptext">Demo date</span>
            </div>
            <div class="more-icon">
      ...
      pitchDetails = """
        <span onclick='window.location = "/pitch/#{pitch.pitch_id}/panels"'>
        <div class="pitch-card">
          <div class="body" onclick='window.location = "/pitch/#{pitch.pitch_id}/panels"'>
            <div class="title">#{pitch.name}, Cycle #{pitch.cycle}</div>
            <div class="time">
  ...
  fetchPitchLearners: =>
    self = @
    if pageUrl[1] == 'pitch' && pageUrl.length == 3 && pageUrl[2] != 'setup'
  ...
  populatePitchLearnerRow: (learnerAverage) =>
    ...
    <tr class='pitch-summary' id="">
      <td class='mdl-data-table__cell--non-numeric'>
        <a href='#{pageUrl[2]}/ratings/#{learnerAverage.learners_pitch_id}' class='one-learner-breakdown'>
