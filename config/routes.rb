Rails.application.routes.draw do
  ...
  get "/holistic-csv/:learner_program_id" =>
  "holistic_evaluations#generate_learner_holistic_evaluation_report"
  get "/metrics/:assessment_id" => "assessments#get_assessment_metrics"

  post "/notifications" => "notifications#create"
  delete "/notifications" => "notifications#update"
  resources :index, path: "learners", except: %i(show edit)
  ...
  scope "/learners", as: "bootcampers" do
    ...
    post ":id/:learner_program_id/holistic-evaluations" =>
    "holistic_evaluations#create"
    put ":learner_program_id/holistic-evaluations" =>
    "holistic_evaluations#update"
    post ":id/:learner_program_id/holistic-feedback" =>
    "holistic_feedback#create"
    get ":learner_program_id/evaluation-eligibility" =>
    "holistic_evaluations#eligibility"
    get ":learner_program_id/holistic-average" =>
    "holistic_evaluations#holistic_average"
    get ":learner_program_id/holistic-criteria-average" =>
    "holistic_evaluations#holistic_criteria_averages"
    get ":program_id/holistic-criteria-info" =>
    "holistic_evaluations#holistic_criteria_info"
    ...
    get "/:id/:learner_program_id/get-learner-city" =>
    "learners#get_learner_city"
    put "/:id/:learner_program_id/update-learner" =>
    "learners#update_learner_information"
    get "/:id/:learner_program_id/completed_assessments" =>
    ...
    put "/personal_details/update" =>
    "learners#update_learner_personal_details"
    put "/personal_details/update_link" =>
    "learners#update_learner_project_links"
  end
  ...
  scope "support" do
    get "/" => "support#index"
    get "/users" => "support#get_users"
    get "/roles/:id/permissions" => "support#role_permissions"
    put "/roles/:id/permissions/assign_permission" => "support#assign_permisions"
    delete "/users/:id" => "support#destroy"
  end
  ...
  get "submissions/learner/:learner_program_id" =>
  "submissions#get_learner_assessments_by_phases"
  get "submissions/:learner_program_id" =>
  "submissions#get_learner_submissions", as: "submission"
  get "submissions/:learner_program_id/:phaseId/:assessment_id" =>
  "submissions#get_learner_output"
  get "submissions/:learner_program_id/:assessment_id" =>
  "submissions#get_learner_output"
  ...
  scope "surveys-v2", as: "surveys_v2" do
    ...
    put "/respond/:survey_id/update" => "surveys_v2_respond#update"
  ...
  get "/learner/ecosystem/phases" =>
  "learning_ecosystem#get_learner_ecosystem_phases"
  get "/learner/output/view" => "learning_ecosystem#get_learner_outputs"
  get "learner/get_learner_technical_details" =>
  "learners#get_learner_technical_details"
  put "learner/update_learner_technical_details" =>
  "learners#update_learner_technical_details"
  ...
  scope "programs" do
    ...
    put "/:program_id/phases/:phase_id/assessments" =>
    "programs#save_program_draft"
    ...
    get "/:program_id/program-status" =>
    "learner_programs#get_existing_program"
    get "/:program_id/program-metrics" => "dashboard#program_metrics"
    get "/:program_id/centers/:center/cycles" =>
    "dashboard#cycle_center_metrics"
    get "/:program_id/centers/:center/cycles/:cycle/program-feedback" =>
    "dashboard#program_feedback"
  ...
  resources :pitch, except: %i(show new) do
    resources :panels
  end
  ...
  scope "pitch" do
    ...
    get "/show/:learner_id" => "pitch#show_learner_ratings"
    get "/:pitch_id/ratings/:learner_id" => "pitch#get_rating_breakdown"
    post "/submit_learner_ratings" => "pitch#submit_learner_ratings"
    put "/ratings/:rating_id" => "pitch#edit_rating"
    get "/:pitch_id/panels/:panel_id/:learner_id" => "panels#rate_learners"
    get "/:pitch_id/summary_ratings" => "panels#summary_ratings"
    post "/panel/submit_learner_ratings" => "panels#submit_learner_ratings"
  end
  ...
  get "/framework-criteria/:framework_id/:criterium_id" =>
  "criteria#get_framework_criterium_id"
