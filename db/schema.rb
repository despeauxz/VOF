...
ActiveRecord::Schema.define(version: 20190908135631) do
  ...
  create_table "bootcampers", primary_key: "camper_id", id: :string, force: :cascade do |t|
    ...
    t.text     "github_pages"
    t.text     "story_board"
    t.text     "challenge_one"
    t.text     "challenge_two"
    t.text     "challenge_three"
    t.text     "challenge_four"
    t.text     "heroku_one"
    t.text     "heroku_two"
  ...
  create_table "features", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["feature_name"], name: "index_features_on_feature_name", unique: true, using: :btree
  end
  ...
  create_table "learners_panels", force: :cascade do |t|
    t.string   "camper_id"
    t.integer  "panel_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["panel_id"], name: "index_learners_panels_on_panel_id", using: :btree
  end
  ...
  create_table "panelists", force: :cascade do |t|
    ...
    t.index ["panel_id"], name: "index_panelists_on_panel_id", using: :btree
  end
  ...
  create_table "panels", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string   "created_by"
    t.index ["pitch_id"], name: "index_panels_on_pitch_id", using: :btree
  end
  ...
  create_table "ratings", force: :cascade do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["learners_panel_id"], name: "index_ratings_on_learners_panel_id", using: :btree
  ...
  add_foreign_key "learners_panels", "bootcampers", column: "camper_id", primary_key: "camper_id"
  add_foreign_key "learners_panels", "panels"
  ...
  add_foreign_key "ratings", "learners_panels"
  ...
  create_view "average_ratings", sql_definition: <<-SQL
      SELECT ratings.learners_panel_id,
     ...
     FROM ((ratings
       JOIN learners_panels ON ((ratings.learners_panel_id = learners_panels.id)))
       JOIN bootcampers ON (((learners_panels.camper_id)::text = (bootcampers.camper_id)::text)))
    GROUP BY ratings.learners_panel_id, learners_panels.camper_id, bootcampers.first_name, bootcampers.last_name, learners_panels.panel_id;
  SQL
end
