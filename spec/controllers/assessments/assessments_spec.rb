...
require_relative "../../support/helpers/image_file_mock.rb"
  ...
  describe "GET #get_framework_criteria" do
    context "when loading assessment details with program id" do
      ...
      it "returns a json with a count of " do
        ...
        expect(json["frameworks"][0]["name"]).to eq "Output Quality"
      end
  ...
  describe "PUT #update_assessment_output" do
    ...
    context "when learner tries updating good output" do
      before do
        ...
        file = fixture_file_upload "spec/fixtures/output_file.png", "image/png"
        @output_update[:submission_file] = file
        Fog::Mock.reset
        Fog.mock!
        ...
        connection.directories.create(key: "learner-submission-uploads-staging")
        put :update_assessment_output, params: @output_update
      end
